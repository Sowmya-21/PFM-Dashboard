...
const features = [
  {
    ...
    desc: "Easily monitor your daily and monthly expenses.",
    icon: Wallet,
  },
  {
    title: "Set Budgets",
    desc: "Stay on top of your finances by setting smart budgets.",
    icon: Target,
  },
  {
    title: "View Reports",
    desc: "Visualize your spending with clean analytics.",
    icon: BarChart3,
  },
  {
    title: "Sync Accounts",
    desc: "Connect multiple bank accounts securely.",
    icon: Link,
  },
  {
    title: "Smart Insights",
    desc: "AI-driven insights to help you save more.",
    icon: Lightbulb,
  },
  {
    title: "Secure & Private",
    desc: "Your data stays safe with end-to-end encryption.",
    icon: ShieldCheck,
  },
];
...
const LandingPage: React.FC<LandingPageProps> = ({ onLogin, onSignup }) => {
  ...
  return (
    <div className="font-poppins text-white overflow-hidden">
      {/* ====== HERO SECTION (FULL BLUE) ====== */}
      <div
        id="home"
        className="relative min-h-screen bg-gradient-to-br from-[#0f4ba3] to-[#092f63] flex flex-col"
      >
        {/* Decorative Dots Overlay */}
        <div className="absolute inset-0 bg-[radial-gradient(rgba(255,255,255,0.07)_1px,transparent_1px)] bg-[size:40px_40px] z-0" />
        ...
        {/* ====== NAVBAR ====== */}
        <header className="z-10 flex justify-between items-center px-10 py-6 sticky top-0">
          <h1 className="text-2xl font-bold text-white">FinancePal</h1>

          <nav className="flex items-center space-x-8">
            <button
              onClick={() => scrollToSection("home")}
              className="hover:text-[#ffe35a] transition"
            >
              Home
            </button>
            <button
        ...
        >
          <h2 className="text-5xl font-bold mb-6 leading-tight">
            ...
            <span className="text-[#ffe35a]">Finances</span>
          </h2>
          <p className="text-[#cdd6f3] text-lg max-w-2xl mb-10">
            Manage your money smarter with insights, tracking, and reports — all
      ...
      <section
        id="about"
        className="bg-white text-[#0f4ba3] py-20 px-6 text-center"
      >
        {/* About FinancePal */}
        <div className="max-w-4xl mx-auto mb-16">
          <h3 className="text-4xl font-bold mb-6">About FinancePal</h3>
          <p className="text-gray-700 text-lg leading-relaxed">
            FinancePal is your trusted companion for smarter money management.
            Our mission is to make financial tracking simple, intuitive, and
            effective. We help you monitor spending, plan budgets, and get
            actionable insights to reach your goals — all in one secure
            platform.
          </p>
        </div>
      ...
      <footer className="bg-[#0f4ba3] text-white text-center py-6">
        <p>
          © {new Date().getFullYear()} FinancePal — Smart Finance Management
        </p>
      </footer>
    </div>
  );
